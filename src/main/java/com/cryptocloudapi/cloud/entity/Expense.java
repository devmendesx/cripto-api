...
import com.cryptocloudapi.cloud.model.ExpenseStatus;
...
public class Expense {
    ...
    @ManyToOne(targetEntity = User.class) @JoinColumn(nullable = false, referencedColumnName = "cod_user")
    private User user;
